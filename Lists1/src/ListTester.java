...
public class ListTester {
	...
	private void runTests() {
		...
		testTwoElementList(A_add1B_BA, "A_add1B_BA", LIST_AB, STRING_AB);
		...
		//Iterator 1-element to empty list
		...
		//Iterator 2-element to 1-element
		testSingleElementList(AB_iterRemoveA_B, "AB_iterRemoveA_B", LIST_A, STRING_A);
		testSingleElementList(CA_iterRemoveC_A, "CA_iterRemoveC_A", LIST_A, STRING_A);
...
//			break;
	...
	/** Scenario: [B] -> removeLast -> empty list 
	 * @return [] after removeLastA()
	 */
	...
	private Scenario<Integer> A_add1B_BA = () -> A_add1B_AB();
	...
	/** Scenario: [C,A] -> iterRemoveC -> [A] 
	 * @return [A] after iteratorRemoveAfterNextC
	 */
	private IndexedUnsortedList<Integer> CA_iterRemoveC_A() {
		IndexedUnsortedList<Integer> list = BA_set0C_CA() ; 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.remove();
		return list;
	}
	private Scenario<Integer> CA_iterRemoveC_A = () -> CA_iterRemoveC_A();
	/////////////////////////////////
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			// IndexedUnsortedList
						...
						printTest(scenarioName + "_testRemove2", testRemoveElement(scenario.build(), null, Result.NoSuchElement));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove3", testRemoveElement(scenario.build(), null, Result.NoSuchElement));
