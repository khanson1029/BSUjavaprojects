...
public class ListTester {
	...
	private void runTests() {
		...
		// newly constructed empty list (provided)
		testEmptyList(newList, "newList");
		// empty to 1-element list
		testSingleElementList(emptyList_addToFrontA_A, "emptyList_addToFrontA_A", LIST_A, STRING_A); // provided
		...
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA); // provided
		...
		testThreeElementList(ABC_set1D_ADC, "ABC_set2D_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_set2D_ABD, "ABC_set2D_ABD", LIST_ABD, STRING_ABD);

		// iter tests
		// 1-element to empty list (provided)
		...
		// 3-element to 2-element
		testTwoElementList(ABC_IterRemoveA_BC, "ABC_IterRemoveC_AB", LIST_BC, STRING_BC);
...
//			break;
	...
	/**
	 * Scenario: [A,B,C] -> iteratorRemoveA -> [B,C]
	 * 
	 * @return [B,C] after iteratorRemoveA
	 */
	...
	// Single Linked List additional seven
	/**
	 * Scenario: [A] -> removeA -> []
	 * 
	...
	/**
	 * Scenario: [A,B] -> set2C -> [A,B,C]
	 * 
	 * @return [A,B,C] after set2C
	 */
	...
	// sll iter tests
	/**
	 * Scenario: [A,B,C] -> iteratorRemoveB -> [A,C]
	 * 
	 * @return [A,C] after iteratorRemoveB
	 */
	...
	/**
	 * Scenario: [A,B,C] -> iteratorRemoveC -> [A,B]
	 * 
	 * @return [A,B] after iteratorRemoveC
	 */
